...
const chapter12Questions = [
  ...
  },
  {
    ...
    correct: 1,
    explanation: "Claude Opus 4.1 achieved 49% on GDPval, outperforming GPT-5"
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correct: 3,
    explanation: "The Five Powers are: See, Hear, Reason, Act, and Remember. While learning is important, "
  },
  {
    id: 14,
  ...
  },
  {
    ...
    correct: 1,
    explanation: "GPT-5 achieved 40.6% on GDPval, which while lower than Claude Opus 4.1"
  },
  {
    id: 19,
  ...
  },
  {
    ...
    correct: 2,
    explanation: "Gemini solved 10 out of 12 problems at ICPC 2025, demonstrating strong competitive programming capabilities, though slightly behind OpenAI"
  },
  {
    id: 21,
  ...
  },
  {
    ...
    correct: 3,
    explanation: "The OODA Loop concludes with "
  },
  {
    id: 49,
  ...
  },
  {
    ...
    correct: 2,
    explanation: "The Agent Maturity Model"
  },
  {
    id: 52,
...
const chapter13Questions = [
  ...
  },
  {
    ...
    options: ["It makes the document look more professional", "It helps LLMs process information hierarchically and maintain context", "It reduces file size", "It"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["They read everything at once without order", "They process sequentially with attention mechanisms that use structure as cues", "They only read headers and ignore content", "They process randomly based on keywords"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["## Instructions", "## Problem", "## Details", "## Information"],
    correct: 1,
    explanation: "The "
  },
  {
    ...
    options: ["To list marketing benefits", "To enumerate specific capabilities or requirements the solution must have", "To describe bugs", "To provide version history"],
    correct: 1,
    explanation: "The "
  },
  {
    ...
    options: ["When you have more than 5 items", "When the sequence or priority of items matters", "When items are longer than one line", "When writing code examples"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["4 spaces", "1 tab", "2 spaces", "3 spaces"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Use tabs for each level", "Add 2 spaces for each nesting level", "Use 4 spaces regardless of level", "Avoid nesting beyond one level"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["When you have more than 3 items", "When presenting actual code, commands, or output that should be preserved exactly", "When items contain numbers", "When you want to emphasize text"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Writing long theoretical explanations", "Providing concrete examples that demonstrate expected behavior or output", "Using only code without explanations", "Listing all possible edge cases"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only error messages", "Concrete examples of what the result should look like", "Source code only", "Performance metrics"],
    correct: 1,
    explanation: "The "
  },
  {
    ...
    options: ["Using HTML anchor tags", "Using meaningful section names that signal content type to both humans and AI", "Creating hyperlinks between sections", "Adding metadata to headers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["## Stuff to Do", "## Requirements", "## Things", "## Notes"],
    correct: 1,
    explanation: ""
  },
  {
    ...
    options: ["Code written at the edge of the screen", "Unusual or boundary conditions that need special handling", "The first and last lines of code", "Code that runs slowly"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ignore them to keep instructions simple", "Provide specific examples showing the edge case and expected handling", "Only mention them in comments", "List them without examples"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Links that only work in references sections", "Links where the URL is defined separately and referenced by label", "Links to academic papers", "Broken links that need fixing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["[label]: URL", "(label): URL", "[label] = URL", "label: URL"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["To make images load faster", "To describe image content for accessibility and when images fail to load", "To add captions below images", "To improve SEO only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It looks better visually", "Bold emphasis signals absolute requirements vs recommendations to AI", "It", ",\n      "],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It does not affect AI processing", "Bold and italic provide visual cues that signal importance and requirement levels", "It only helps human readers", "It makes processing slower"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["**optional**", "*optional* or no emphasis", "***optional***", "~~optional~~"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Using too many items", "Inconsistent indentation or mixing spaces and tabs", "Using numbers instead of bullets", "Adding too much text"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Making them too long", "Forgetting to specify the language or using incorrect fencing", "Using too many comments", "Including line numbers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Missing language specifier", "Incorrect closing fence (two backticks instead of three)", "Function is too simple", "Missing semicolon"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["URL is wrong", "Reversed syntax - should be [text](url)", "Missing protocol", "Text is too short"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Always use bullets, never numbers", "Consistent punctuation, parallel structure, and appropriate list type", "Never use more than 5 items", "Always end items with periods"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Use H1 for each section", "Use H1 for title, H2 for main sections, H3+ for subsections", "Use only H2 headers", "Avoid using headers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Vague descriptions", "Specific, testable capabilities with clear acceptance criteria", "Marketing language", "Technical jargon only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Just add the code block without indentation", "Indent the code block to align with the list item content", "Use inline code only", "End the list first"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Use as many words as possible", "Combine clear structure, semantic sections, and concrete examples", "Avoid all formatting", "Use only code blocks"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It reduces the total number of pages needed", "It allows incremental detail addition as requirements become clearer", "It eliminates the need for code comments", "It automatically generates test cases"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only functional requirements", "Security, performance, accessibility, and error handling", "Just the user interface design", "Only database schema definitions"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Deploy to production", "Parse structure to identify sections and hierarchy", "Write unit tests", "Create user documentation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["2 steps", "3 steps", "4 steps", "5 steps"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Automatic code generation without review", "Parse structure, find information, and validate completeness", "Elimination of human developers", "Instant deployment capabilities"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["CommonMark", "GitHub Flavored Markdown (GFM)", "MultiMarkdown", "Markdown Extra"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Subsection titles within features", "Document title or main topic", "Code block labels", "Table headers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["For the document title", "For major sections", "For subsections within a level 2 section", "Never, only use levels 1 and 2"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Random collection of items", "Sequence, priority, or steps that must follow a specific order", "Only alphabetical sorting", "Unimportant information"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["To create extra-large code blocks", "To show code that itself contains triple backticks", "To add syntax highlighting", "To create inline code"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["They load too slowly", "They require maintaining relative paths and file availability", "They cannot be displayed in browsers", "They use more disk space"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only use black and white images", "Image clarity, relevance, and context to help AI understand purpose", "Always use the largest possible file size", "Never include images with AI"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Never using bold or italic", "Overusing emphasis, making everything bold or italic and reducing impact", "Using asterisks instead of underscores", "Combining bold and italic"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Forward slash (/)", "Backslash (\\\\)", "Caret (^)", "Tilde (~)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Creates a new paragraph", "Treated as a space, not a line break", "Creates a horizontal rule", "Starts a code block"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Single newline", "Use a blank line (two newlines)", "Use a semicolon", "Indent the text"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Marketing materials", "Purpose, scope, functional requirements, and acceptance criteria", "Only code examples", "Social media links"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Waterfall-only specification", "Progressive specification with incremental detail", "No specification needed", "Code-first with no documentation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Deploy the application", "Find and extract specific information from sections", "Delete old versions", "Create backup copies"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Publish documentation", "Validate completeness against required components checklist", "Archive the project", "Generate random test data"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Start coding immediately", "Check consistency and identify conflicts or gaps", "Delete the specification", "Create a new project"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["GitHub Flavored Markdown", "Markdown Extra", "CommonMark", "Basic Markdown"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A proprietary Markdown format", "A standardized, unambiguous specification of Markdown", "A deprecated Markdown version", "A Markdown editor"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Storing passwords", "Project overview, setup instructions, and usage documentation", "Compiling code", "Database backups"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Replacing all databases", "Static site generators like Jekyll, Hugo, or MkDocs", "Video editing", "Image processing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["For the document title", "For major sections within the document", "For inline emphasis", "For code comments"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Level 2", "Level 3", "Level 4 or 5", "Level 10"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Strict sequence that must be followed", "Collection of related items without implied order", "Alphabetical organization only", "Deprecated information"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Use different bullet characters", "Nest the dependent task under the prerequisite or add explicit text", "Use strikethrough", "Change the font size"],
    correct: 1,
    explanation: "Dependencies can be shown through nesting (indentation) or explicit textual references like "
  },
  {
    id: 136,
    question: "What language identifier should follow triple backticks for JavaScript code?",
    options: ["```js or ```javascript", "```code", "```script", "```java"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["To make code run faster", "To show examples of Markdown code blocks without triggering parsing", "To add extra security", "To compress the code"],
    correct: 1,
  ...
  },
  {
    id: 138,
    question: "What is the Markdown syntax for an image with alt text?",
    options: ["[alt text](image.png)", "![alt text](image.png)", "<img>alt text</img>", "{image: alt text}"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Absolute paths only", "Relative paths from the document location", "Network paths only", "Random paths"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["No context needed", "Description of what the diagram shows and what to focus on", "Only the file size", "The creation date"],
    correct: 1,
    explanation: "Providing context about the diagram"
  },
  {
    id: 141,
    question: "What happens when you overuse bold text in documentation?",
    options: ["It improves readability", "It loses emphasis value and makes text harder to scan", "It increases font size", "It changes the color"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Use <table> tags", "Use pipes (|) to separate columns and dashes for headers", "Use tabs between columns", "Use commas like CSV"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Center", "Left-aligned", "Right-aligned", "Justified"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Single newline", "Two spaces at the end of a line followed by newline", "Use a comma", "Use a semicolon"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Nothing, errors are unexpected", "Expected error scenarios and how to handle them", "Only success cases", "Error handling is optional"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["To make the document longer", "To define measurable conditions for feature completion", "To confuse developers", "They are optional and not important"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Security", "Performance", "Accessibility", "Maintainability"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["All at once at the beginning", "Incrementally as understanding and needs become clearer", "Never add technical details", "Only after the project is complete"],
    correct: 1,
    explanation: "Progressive specification adds technical details incrementally as the team"
  },
  {
    id: 150,
...
const chapter14Questions = [
  {
    ...
    options: ["Sam Altman", "Boris Cherny", "Dario Amodei", "Andrej Karpathy"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Excess inventory of software products", "The gap between AI capabilities and product implementation", "Overpriced software subscriptions", "Delayed product releases"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["Day 3", "Day 5", "Day 7", "Day 10"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["Active vs Reactive", "Agentic vs Passive", "Proactive vs Defensive", "Dynamic vs Static"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Passive AI", "Reactive AI", "Agentic AI", "Static AI"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Simple and Complex Agents", "General and Custom Agents", "Basic and Advanced Agents", "Primary and Secondary Agents"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Observe, Operate, Decide, Act", "Observe, Orient, Decide, Act", "Operate, Orient, Deploy, Analyze", "Observe, Optimize, Deploy, Act"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Native installers", "Homebrew", "npm", "Docker"],
    correct: 3,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["macOS 11+", "macOS 12+", "macOS 13+", "macOS 14+"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Windows 8+", "Windows 10+", "Windows 11+", "Windows Server 2019+"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Claude App", "Console API", "Enterprise SSO", "OAuth2"],
    correct: 3,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["claude auth", "claude signin", "claude login", "claude connect"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["claude signout", "claude logout", "claude disconnect", "claude exit"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["CLAUDE_API_KEY", "ANTHROPIC_KEY", "ANTHROPIC_API_KEY", "API_KEY_ANTHROPIC"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["ChatGPT", "OpenRouter", "Copilot", "Tabnine"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["OpenRouter", "Gemini", "DeepSeek", "GPT-4"],
    correct: 3,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["~/.claude/settings.json", "~/.claude/config.json", "~/.config/claude.json", "~/claude/config.json"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["N", "Delete", "Esc", "Backspace"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Operate", "Optimize", "Observe", "Organize"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Operate", "Orient", "Optimize", "Output"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["August 2024", "September 2024", "October 2024", "November 2024"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["npm", "Native installers", "Homebrew", "pip"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["General Agents", "Custom Agents", "Universal Agents", "Basic Agents"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Specialized Agents", "Custom Agents", "General Agents", "Focused Agents"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Agentic AI", "Proactive AI", "Passive AI", "Dynamic AI"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["Observe", "Orient", "Decide", "Act"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["Claude App", "Console API", "Enterprise SSO", "API Key"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["20% to 40%", "20% to 50%", "30% to 60%", "10% to 50%"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["OpenRouter", "DeepSeek", "Gemini", "Bard"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["~/.config", "~/.claude", "~/claude", "~/.anthropic"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["2% of private commits", "4% of all public commits", "6% of enterprise commits", "8% of open source commits"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Technology Gap", "Product Overhang", "Innovation Lag", "Development Debt"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Click buttons", "Type commands", "Press Enter or Esc", "Voice commands"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["4 sections", "5 sections", "6 sections", "7 sections"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Project, Tech Stack, Development, Conventions, Workflows, Notes", "Project, Architecture, Development, Testing, Deployment, Notes", "Overview, Stack, Setup, Guidelines, Processes, Documentation", "Introduction, Technology, Build, Standards, Operations, References"],
    correct: 0,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["November 15, 2025", "December 1, 2025", "December 9, 2025", "January 1, 2026"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Build more agents, build faster", "Stop building agents, build skills", "Agents first, skills second", "Build agents with embedded skills"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Two: bundled and custom", "Three: bundled, foundational, partner", "Four: bundled, foundational, partner, custom", "Five: bundled, foundational, partner, community, custom"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Internal, external, community", "Core, extended, custom", "Bundled, foundational, partner", "Built-in, imported, user-defined"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["skillsregistry.io", "agentskills.io", "claudeskills.io", "openagents.io"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Header and content", "Metadata and instructions", "YAML frontmatter and markdown body", "Configuration and implementation"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["skill-builder", "skill-generator", "skill-creator", "create-skill"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["no-model-call: true", "disable-model-invocation: true", "skip-model: true", "model-disabled: true"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Explore", "Plan", "Debug", "Bash"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Three: Explore, Plan, Bash", "Four: Explore, Plan, general-purpose, Bash", "Five: Explore, Plan, Debug, Test, Bash", "Two: Explore and Plan"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["sandbox", "container", "worktree", "virtual-env"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["# hashtag syntax", "@ at-mention syntax", "/ slash command syntax", ": colon prefix syntax"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Selenium MCP", "Puppeteer MCP", "Playwright MCP", "Cypress MCP"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Database management", "Context management and retrieval", "File system operations", "Network monitoring"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["Two: User and Project", "Three: User, Project, Local", "Four: Global, User, Project, Local", "Five: System, Global, User, Project, Local"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["User > Project > Local", "Project > Local > User", "Local > Project > User", "Local > User > Project"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["User", "Project", "Local", "Global"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["A project-specific agent configuration", "A universal standard for agent definitions", "A list of available agents", "Agent deployment instructions"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["Project", "Tech Stack", "Development", "Conventions"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["To speed up execution", "To prevent Claude from making additional model calls during skill execution", "To disable the skill entirely", "To run the skill in offline mode"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Plan", "Explore", "Bash", "general-purpose"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["To improve performance", "To create isolated working environments for different tasks", "To backup code automatically", "To enable parallel execution"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["/test-runner", "#test-runner", "@test-runner", ":test-runner"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Model Context Protocol", "Multi-Component Platform", "Managed Code Provider", "Message Control Protocol"],
    correct: 0,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Faster execution time", "Reduced number of tools exposed to the model", "Lower memory usage", "Better error handling"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Execution speed", "Memory usage", "Context window usage", "Network bandwidth"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["User level", "Project level", "Local level", "The first one defined"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["They are competing standards", "AAIF formed the agentskills.io open standard", "agentskills.io predates AAIF", "They are unrelated"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Bundled", "Foundational", "Partner", "Core"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Faster execution", "Reusability and composability", "Lower cost", "Better security"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Development", "Conventions", "Tech Stack", "Workflows"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Development", "Conventions", "Workflows", "Notes"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["To store configuration", "To provide instructions and documentation for the skill", "To define dependencies", "To specify permissions"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["A custom agent", "A built-in agent", "A partner agent", "A foundational agent"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Database testing", "Browser automation and testing", "API testing", "Performance monitoring"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["User level", "Project level", "Local level", "Global level"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Claude Code release date", "AAIF formation date", "agentskills.io launch date", "MCP protocol release date"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Bundled", "Foundational", "Partner", "External"],
    correct: 0,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["Code exploration", "Task planning", "Handling general tasks without specific specialization", "Shell command execution"],
    correct: 2,
    explanation: "No explanation available."
  },
  {
    ...
    options: ["By removing unused tools", "By intelligently filtering and exposing only relevant tools", "By compressing tool definitions", "By caching tool results"],
    correct: 1,
    explanation: "No explanation available."
  },
  {
  ...
  },
  {
    ...
    options: ["auto", "default", "acceptEdits", "bypassPermissions"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["default", "auto", "acceptEdits", "bypassPermissions"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["SessionStart", "PreToolUse", "PostToolUse", "UserPromptSubmit"],
    correct: 1,
  ...
  },
  {
    ...
    options: [".claude/plugin.json", ".claude-plugin/plugin.json", "plugins/config.json", ".config/claude-plugin.json"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["agent", "prompt", "command", "http"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["/plugins", "/plugin", "/manage-plugin", "/add-plugin"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["CLAUDE_AGENT_TEAMS=1", "CLAUDE_CODE_AGENT_TEAMS=1", "CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1", "ENABLE_AGENT_TEAMS=1"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Ctrl+Tab", "Shift+Tab", "Alt+Tab", "Ctrl+Shift+D"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["CronSchedule", "CronCreate", "TaskCreate", "ScheduleCreate"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["/persist", "/schedule", "/cloud-schedule", "/save-schedule"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["CronShow", "CronList", "ListCron", "ShowSchedule"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["CronRemove", "CronDelete", "DeleteCron", "RemoveSchedule"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["claude remote", "claude --remote", "claude remote-control", "claude rc"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["/remote", "/rc", "/remote-control", "/control"],
    correct: 1,
  ...
  },
  {
    ...
    options: [".git/worktrees/", ".claude/worktrees/", "worktrees/", ".worktrees/"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["--wt", "--worktree", "--work-tree", "-w"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Web application", "CLI tool", "Desktop app", "Browser extension"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["M1+", "M2+", "M3+", "Any Apple Silicon"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["v1.0.30+", "v1.0.36+", "v1.0.40+", "v1.1.0+"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Windows", "Linux", "macOS", "All platforms"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["PreToolUse", "PostToolUse", "ToolComplete", "SessionEnd"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["PromptSubmit", "UserPrompt", "UserPromptSubmit", "SubmitPrompt"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["SessionStart", "StartSession", "SessionBegin", "InitSession"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["SessionClose", "SessionEnd", "EndSession", "CloseSession"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["inject", "prompt", "message", "context"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["delegate", "agent", "subagent", "worker"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["auto", "bypass", "bypassPermissions", "noPermissions"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Infinite loops in code", "Recurring task execution", "Loop detection", "Circular dependency resolution"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["auto", "acceptEdits", "default", "bypassPermissions"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Code review automation", "Multi-agent collaboration", "Team management", "Version control"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Delete files", "Assign tasks to other agents", "Bypass permissions", "Create new sessions"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Faster execution", "Survive session restarts", "Better performance", "Lower cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Remote debugging", "Mobile device control", "Cross-device Claude Code access", "Remote server management"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Faster compilation", "Isolated development environments", "Better version control", "Reduced disk usage"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Better performance", "Desktop GUI interface", "More features", "Lower cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Web scraping", "Browser automation", "Claude Code in browser context", "Extension development"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Advanced AI Framework", "Anthropic AI Integration Forum", "AI Adoption and Innovation Forum", "Automated AI Functions"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Code quality", "Software engineering task performance", "Security vulnerabilities", "Execution speed"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["CronCreate", "CronList", "CronDelete", "CronShow"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Store user preferences", "Define plugin configuration and metadata", "Log plugin activity", "Cache plugin data"],
    correct: 1,
    explanation: "plugin.json defines the plugin"
  },
  {
    id: 150,
    question: "What happens when session-scoped schedules reach the 50-task limit?",
    options: ["Oldest tasks are deleted", "New tasks are rejected", "Tasks are moved to cloud", "Session is terminated"],
    correct: 1,
